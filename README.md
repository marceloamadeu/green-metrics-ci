...
```bibtex
@inproceedings{amadeu2025green,
  title={O Custo Energético da Qualidade: Um Estudo Experimental sobre a Otimização de Testes em Integração Contínua},
  author={Amadeu, Marcelo Andrade},
  booktitle={Workshop Brasileiro de Engenharia de Software Verde},
  year={2025}
}
```
...
Marcelo Andrade Amadeu - marceloandradeamadeu@gmail.com